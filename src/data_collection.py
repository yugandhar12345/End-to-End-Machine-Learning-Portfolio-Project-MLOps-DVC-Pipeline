...
def main():
    data_filepath = r"D:\Mlops\Datasets\DS\water_potability.csv"
    params_filepath = "D:\Mlops\FastAPI-Water-Potability-Prediction-Using-Machine-Learning/params.yaml"
...
# data_path = os.path.join("data","raw")
    try:
        ...
        save_data(train_data,os.path.join("D:\Mlops\KAGGLE-COMPETITION\train.csv"))
        save_data(test_data, os.path.join("D:\Mlops\KAGGLE-COMPETITION\test.csv"))
    except Exception as e:
